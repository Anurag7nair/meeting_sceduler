        ...
        <div className='flex flex-col gap-3 my-4'>
            ...
            <div className='flex justify-evenly gap-3 flex-wrap'>
                {ThemeOptions.map((color,index)=>(
                    <div key={index} className={`h-10 w-10 rounded-full cursor-pointer transition-all hover:scale-110 shadow-md hover:shadow-lg
                    ${themeColor==color?' border-4 border-slate-800 ring-2 ring-offset-2 ring-slate-300':' border-2 border-slate-200'}`}
